...
function displayResult(result) {
  var isReal = result.prediction === 'REAL';
  ...
  var html = '<div class="card border-2 ' + borderColor + ' animate-fade-in">' +
    '<div class="flex items-center justify-between mb-6">' +
      ...
      '<span class="' + badgeClass + '"><i class="fas ' + badgeIcon + ' mr-1"></i> ' + result.prediction + ' NEWS</span>' +
    '</div>' +
    ...
    '<div class="grid sm:grid-cols-3 gap-4">' +
      '<div>' +
        '<p class="text-dark-500 text-xs mb-2">SENTIMENT</p>' +
        '<div class="px-3 py-2 rounded-lg text-sm font-medium ' + sentimentBadge + '">' +
          result.sentiment + ' (' + result.sentiment_score.toFixed(2) + ')' +
        '</div>' +
      '</div>' +
      '<div>' +
